...
# Configuration
Enable handler
  * handlers = diamond.handler.netuitive_cloud.NetuitiveHandler2
...
class NetuitiveHandler(Handler):
    ...
    def get_default_config_help(self):
        ...
        """
        config = super(NetuitiveHandler2, self).get_default_config_help()
    ...
    def get_default_config(self):
        ...
        config = super(NetuitiveHandler2, self).get_default_config()

        config.update({
            'url': 'https://api.uat.netuitive.com/ingest/infrastructure',
            'api_key': 'e73422633b7a0daa838ea6aec60e5bbc',
            'tags': None,
            'relations': None,
            'location': None,
            'batch': 100,
